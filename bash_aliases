...
_iscmd=false
[[ "$(hostname)" =~ MTLUCMDS1|RS30134650|RS30090329|RS30106828|MTLUCMDS2|mtlucmds2|rs-fs1|rs-fe1 ]] && _iscmd=true
...
if $_iscmd; then
   ...
   alias squeuelong='squeue -o "%7i %7u %.8M %.10l %65j %2t %.8M %7P %.5Q %.5m %2C %19S %6E %13R" --sort=-S,p,i'
